...
export const WikiView: React.FC = () => {
  ...
  const tabs = [
    { id: 'overview', label: '1. Быстрый старт и Фото касс', icon: RiComputerLine },
    { id: 'screens', label: '2. Зоны экранов (1024x768 / 512x768)', icon: RiStackLine },
    { id: 'admin', label: '3. Подключение кассы (Сисадмину)', icon: RiTerminalBoxLine },
    { id: 'operator', label: '4. Публикация и Волны (Маркетологу)', icon: RiFlashlightLine },
    { id: 'backup', label: '5. Бэкапы и Восстановление', icon: RiHardDrive2Line },
    { id: 'faq', label: '6. Частые вопросы (FAQ)', icon: RiQuestionLine },
  ];
...
docker restart guestscreen_fastapi_server`;
  ...
  return (
    <div className="min-h-screen bg-[#08090c] text-slate-100 font-sans antialiased selection:bg-blue-600/30 selection:text-blue-200">
      {/* Top Standalone Header */}
      <header className="sticky top-0 z-50 bg-[#0d1017]/90 border-b border-[#1f2536] px-6 py-3.5 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          >
            ...
            <div>
              <div className="flex items-center space-x-2">
                <span className="font-extrabold text-sm tracking-tight text-white uppercase group-hover:text-blue-400 transition-colors">
                  {brand.name}
                </span>
          ...
          <div className="flex items-center space-x-4">
            <a
              ...
              className="hidden sm:flex items-center space-x-2 px-3.5 py-2 rounded-xl bg-blue-600/20 hover:bg-blue-600/40 text-blue-300 hover:text-white border border-blue-500/30 text-xs font-semibold transition-all cursor-pointer"
            >
            ...
            <a
              href="/devices"
              className="text-xs font-medium text-slate-400 hover:text-white transition-colors flex items-center space-x-1 cursor-pointer"
            >
      ...
      <main className="p-6">
        <div className="space-y-6 max-w-6xl mx-auto pb-12">
          ...
          <div className="bg-[#11141e] rounded-2xl p-6 border border-[#1f2536] shadow-xl relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-start space-x-4">
              <div className="p-3.5 rounded-xl bg-blue-500/15 border border-blue-500/30 text-blue-400">
            ...
            <div className="flex items-center space-x-3 w-full md:w-auto">
              <a
                href="/downloads/GuestScreen_Wiki_Manual.docx"
                download="GuestScreen_Wiki_Manual.docx"
                className="flex items-center justify-center space-x-2.5 px-5 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm shadow-lg shadow-blue-600/30 border border-blue-400/30 transition-all w-full md:w-auto group cursor-pointer"
              >
                <RiDownloadLine className="w-4 h-4 transition-transform group-hover:-translate-y-0.5" />
          ...
          <div className="flex space-x-1.5 overflow-x-auto pb-2 scrollbar-none border-b border-[#1e293b]">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center space-x-2 px-4 py-2.5 rounded-xl text-xs font-semibold whitespace-nowrap transition-colors cursor-pointer z-10 ${
                    isActive
          ...
          <div className="space-y-6">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                <div className="bg-[#111928] rounded-2xl p-6 border border-[#1e293b] shadow-xl space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                    <div className="p-3.5 rounded-xl bg-[#0b111e] border border-[#1e293b]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    <div className="space-y-2">
                      <div className="rounded-xl overflow-hidden border border-[#1e293b] bg-[#0b111e] flex items-center justify-center p-2">
                        <img 
            ...
            {activeTab === 'screens' && (
              <div className="space-y-6">
                <div className="bg-[#111928] rounded-2xl p-6 border border-[#1e293b] shadow-xl space-y-4">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <RiStackLine className="w-5 h-5 text-indigo-400" />
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-[#162033] hover:bg-[#1e2b44] text-xs text-slate-200 transition-all cursor-pointer"
                      >
                        {copiedSnippet === 'ps-admin' ? <RiCheckLine className="w-3.5 h-3.5 text-emerald-400" /> : <RiFileCopyLine className="w-3.5 h-3.5" />}
                        <span>{copiedSnippet === 'ps-admin' ? 'Скопировано!' : 'Копировать команды'}</span>
                      </button>
                    </div>

                    <div className="p-4 rounded-xl bg-[#0b111e] font-mono text-xs text-emerald-300 border border-[#1e293b] overflow-x-auto whitespace-pre leading-relaxed">
                      {psCode}
                    </div>
                  </div>
            ...
            {activeTab === 'operator' && (
              <div className="space-y-6">
                <div className="bg-[#111928] rounded-2xl p-6 border border-[#1e293b] shadow-xl space-y-4">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <RiFlashlightLine className="w-5 h-5 text-amber-400" />
                    <span>Публикация рекламы и волновой деплой (Маркетологу)</span>
                  </h2>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                    <div className="p-4 rounded-xl bg-[#0b111e] border border-[#1e293b] space-y-1.5">
                      <div className="w-6 h-6 rounded-md bg-cyan-500/20 text-cyan-400 font-bold flex items-center justify-center text-xs">1</div>
                  ...
                  <div className="p-4 rounded-xl bg-[#0b111e] border border-[#1e293b] space-y-2 text-xs text-slate-300">
            ...
            {activeTab === 'backup' && (
              <div className="space-y-6">
                <div className="bg-[#111928] rounded-2xl p-6 border border-[#1e293b] shadow-xl space-y-4">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <RiHardDrive2Line className="w-5 h-5 text-blue-400" />
                    <span>Резервное копирование и Восстановление базы</span>
                  </h2>

                  <div className="p-4 rounded-xl bg-[#0b111e] border border-[#1e293b] space-y-1.5 text-xs text-slate-300">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="flex items-center space-x-1.5 px-3 py-1.5 rounded-lg bg-[#162033] hover:bg-[#1e2b44] text-xs text-slate-200 transition-all cursor-pointer"
                      >
                        {copiedSnippet === 'restore-code' ? <RiCheckLine className="w-3.5 h-3.5 text-emerald-400" /> : <RiFileCopyLine className="w-3.5 h-3.5" />}
                        <span>{copiedSnippet === 'restore-code' ? 'Скопировано!' : 'Копировать команды'}</span>
                      </button>
                    </div>

                    <div className="p-4 rounded-xl bg-[#0b111e] font-mono text-xs text-cyan-300 border border-[#1e293b] overflow-x-auto whitespace-pre leading-relaxed">
                      {restoreCode}
                    </div>
                  </div>
                </div>
            ...
            {activeTab === 'faq' && (
              <div className="space-y-4">
                <div className="bg-[#111928] rounded-2xl p-6 border border-[#1e293b] shadow-xl space-y-4">
                  <h2 className="text-lg font-bold text-white flex items-center space-x-2">
                    <RiQuestionLine className="w-5 h-5 text-amber-400" />
                    <span>Шпаргалка по частым инцидентам (FAQ)</span>
                  </h2>

                  <div className="space-y-3 text-xs">
                    <div className="p-4 rounded-xl bg-[#0b111e] border border-[#1e293b] space-y-1">
